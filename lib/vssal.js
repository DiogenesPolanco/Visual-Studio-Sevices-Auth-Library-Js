...
var ContextVssal = (function() {
     ...
     * @ignore
     */
    ContextVssal.prototype._openPopup = function(urlNavigate, title, popUpWidth, popUpHeight) {
        try {
            /**
     ...
     * @ignore
     */
    ContextVssal.prototype._loginPopup = function(urlNavigate) {
    ...
    ContextVssal.prototype._renewToken = function(resource, callback) {
        ...
        var frameHandle = this._addvssalFrame('vssalRenewFrame' + resource);
     ...
     * @ignore
     */
    ContextVssal.prototype._renewIdToken = function(callback) {
        // use iframe to try refresh token
        this.info('renewIdToken is called');
        var frameHandle = this._addvssalFrame('vssalIdTokenFrame');
        ...
        this.verbose('Navigate to:' + urlNavigate);
        frameHandle.src = 'about:blank';
        this._loadFrameTimeout(urlNavigate, 'vssalIdTokenFrame', this.config.clientId);
    };
     ...
     * @ignore
     */
    ContextVssal.prototype._loadFrameTimeout = function(urlNavigation, frameName, resource) {
     ...
     * @ignore
     */
    ContextVssal.prototype._loadFrame = function(urlNavigate, frameName) {
        ...
        setTimeout(function() {
            var frameHandle = self._addvssalFrame(frameCheck);
     ...
     * @ignore
     */
    ContextVssal.prototype._addHintParameters = function(urlNavigate) {
    ...
    ContextVssal.prototype.getRequestInfo = function(hash) {
        ...
        if (parameters) {
            ...
            if (parameters.hasOwnProperty(this.CONSTANTS.ERROR_DESCRIPTION) ||
                ...
                if (!requestInfo.stateMatch && window.parent && window.parent.ContextVssal) {
                    var statesInParentContext = window.parent.ContextVssal()._renewStates;
     ...
     * @ignore
     */
    ContextVssal.prototype._getNavigateUrl = function(responseType, resource) {
        var tenant = 'common';
        if (this.config.tenant) {
            tenant = this.config.tenant;
        }
     ...
     * @ignore
     */
    ContextVssal.prototype._extractIdToken = function(encodedIdToken) {
     ...
     * @ignore
     */
    ContextVssal.prototype._serialize = function(responseType, obj, resource) {
        var str = [];
        if (obj !== null) {
     ...
     * @ignore
     */
    ContextVssal.prototype._addvssalFrame = function(iframeId) {
        if (typeof iframeId === 'undefined') {
            return;
        }

        this.info('Add vssal frame to document:' + iframeId);
        var vssalFrame = document.getElementById(iframeId);
        ...
        if (!vssalFrame) {
            if (document.createElement && document.documentElement &&
                ...
                vssalFrame = document.getElementsByTagName('body')[0].appendChild(ifr);
            } else if (document.body && document.body.insertAdjacentHTML) {
                document.body.insertAdjacentHTML('beforeEnd', '<iframe name="' + iframeId + '" id="' + iframeId + '" style="display:none"></iframe>');
            }
            if (window.frames && window.frames[iframeId]) {
                vssalFrame = window.frames[iframeId];
            }
        }
     ...
     * @ignore
     */
    ContextVssal.prototype._addLibMetadata = function() {
        // x-client-SKU
        // x-client-Ver
